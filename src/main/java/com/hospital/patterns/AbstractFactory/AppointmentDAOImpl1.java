...
public class AppointmentDAOImpl1 implements AppointmentDAO {
    private final DatabaseConnection dbConnection;

    public AppointmentDAOImpl1() {
    ...
    public boolean save(Appointment appointment) {
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error saving appointment (Impl1): " + e.getMessage());
            return false;
        }
    }
    ...
    public Appointment findById(int id) {
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error finding appointment by ID (Impl1): " + e.getMessage());
        }
        return null;
    }
    ...
    public List<Appointment> findAll() {
        // Implementation 1: Order by date and time
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error finding all appointments (Impl1): " + e.getMessage());
        }
        return appointments;
    }
    ...
    public boolean delete(int id) {
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error deleting appointment (Impl1): " + e.getMessage());
            return false;
        }
    }
