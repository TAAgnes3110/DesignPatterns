...
public class PatientDAOImpl1 implements PatientDAO {
    private final DatabaseConnection dbConnection;

    public PatientDAOImpl1() {
    ...
    public boolean save(Patient patient) {
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error saving patient (Impl1): " + e.getMessage());
            return false;
        }
    }
    ...
    public Patient findById(int id) {
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error finding patient by ID (Impl1): " + e.getMessage());
        }
        return null;
    }
    ...
    public List<Patient> findAll() {
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error finding all patients (Impl1): " + e.getMessage());
        }
        return patients;
    }
    ...
    public boolean delete(int id) {
        ...
        try (Connection conn = dbConnection.getConnection();
            ...
            System.err.println("Error deleting patient (Impl1): " + e.getMessage());
            return false;
        }
    }
